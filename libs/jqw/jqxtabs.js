...
(function ($) {
    ...
    $.extend($.jqx._jqxTabs.prototype, {
        ...
        _addCloseButton: function (index, initialization) {
            ...
            if (currentTitle.querySelector('.jqx-tabs-titleContentWrapper')) {
                currentTitle.innerHTML = currentTitle.querySelector('.jqx-tabs-titleContentWrapper').innerHTML;
            }
