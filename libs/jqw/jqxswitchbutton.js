    ...
    $.extend($.jqx._jqxSwitchButton.prototype, {
        ...
        _switchButton: function (check, duration, notTrigger) {
            ...
            wrapper.animate(options, duration, function () {
                ...
                if (check !== self.checked) {
                    self._raiseEvent(2, { changeType: self.changeType, check: self.checked, checked: self.checked });
        ...
        _handleEvent: function (checked) {
            ...
            if (checked !== this.checked) {
                this._raiseEvent(2, { changeType: self.changeType, check: this.checked, checked: this.checked });
            }
            if (checked) {
                this._raiseEvent(0, { changeType: self.changeType, checked: this.checked });
            } else {
                this._raiseEvent(1, { changeType: self.changeType, checked: this.checked });
            }
        },
